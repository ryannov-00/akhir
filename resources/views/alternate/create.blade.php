        ...
        <h1>Tambah Alternatif</h1>
            ...
            <form action="{{ route('alternatif.store') }}" method="POST">
                ...
                <div class="mb-3 row">
                    ...
                    <div class="col-sm-10">
                        <input type="text" name="kode_alternatif" class="form-control" id="exampleInputEmail1">
                    </div>
                </div>
                <div class="mb-3 row">
                    <label for="exampleInputEmail1" class="col-sm-2 col-form-label">Nama Alternatif</label>
                    <div class="col-sm-10">
                        <input type="text" name="nama_alternatif" class="form-control" id="exampleInputEmail1">
                    </div>
                </div>
                <div class="mb-3 row">
                ...
                <div class="mb-3 row">
                    ...
                    <div class="col-sm-10">
                        <input type="text" name="ranking" class="form-control" id="exampleInputEmail1">
                    </div>
                </div>
                <div class="mb-3 row">
