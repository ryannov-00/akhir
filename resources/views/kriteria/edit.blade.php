...
@section('content')
@section ('title') {{ 'Edit Kriteria' }} @endsection
<div class="container-xxl flex-grow-1 container-p-y">
    ...
    <form action="/kriteria/{{ $kriteria->id }}" method="POST">
        ...
        <div class="mb-3 row">
            ...
            <div class="col-sm-10">
                <input type="text" name="kode" class="form-control" id="exampleInputEmail1" value="{{ $kriteria->kode }}">
            </div>
        </div>
        <div class="mb-3 row">
        ...
        <div class="mb-3 row">
            ...
            <div class="col-sm-10">
                <input type="text" name="bobot" class="form-control" id="exampleInputEmail1" value="{{ $kriteria->bobot }}">
            </div>
        </div>
